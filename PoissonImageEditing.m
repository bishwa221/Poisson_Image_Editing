...
%enumerates white pixel locations in mask into mask_id
mask_id(mask) = 1:N;   
...
for ib=1:N
    ...
    i = ir(ib);%ib element of mask ko row index
    j = ic(ib);%ib element of mask ko column index
...
A = sparse(ir,ic,Np,N,N);%%%%%%%%%%%%%%%yo yo yo yo 1
